...
//           <a ><i className="fas fa-comment"></i></a>
//           <a><i className="fas fa-share"></i></a>
//           <a><i className="fas fa-bookmark"></i></a>
//       </div> 
//       </section>
//       <figure>
...
//               billion years ago.
//             </p>
//             <span className="img-description">Rick Friedman for The New York Times </span>
//         </figcaption>
//       </figure>
//           <br />
//       <section className="section1">
...
//             <a href="https://www.youtube.com/watch?v=ZJYc9YmKIO8" className="nested-links">the first sliver of cosmic time</a>
...
//             ripples in the fabric of space-time — so-
//             <a href="/" className="nested-links">
//               gravitational waves
//             </a>
...
//               <p><span className="bold-cap">THE UNIVERSE</span> is just under 14 billion years old. From our position in the Milky Way galaxy, we can 
//                 observe a sphere that is now about 92 billion 
//                 light-years across. But there's a mystery. Wherever we look, the universe has an even temperature.</p>
//             </div>
             
//             <div className="img-cap">
//               <p><span className="bold-cap">NOT ENOUGH TIME</span> The universe is not old enough for light to have traveled the vast distance from one side of the universe to the other, 
//                 and there has not been enough time for scattered patches of hot and cold to mix into an even temperature.</p>
//             </div>

//             <div className="img-cap">
//               <p><span className="bold-cap">COFFEE  At a smaller scale</span>, imagine using a telescope to look a mile in one direction. 
//                 You see a coffee cup, and from the amount of steam, you can estimate its temperature and how much it has cooled.</p>
//             </div>


//             <div className="img-cap">
//               <p><span className="bold-cap">EVERYWHERE</span> Now turn around and look a mile in the other direction. You see a similar coffee cup, at exactly the same temperature. Coincidence? Maybe.
//                 But if you see a similar cup in every direction, you might want to look for another explanation.</p>
//             </div>

//             <div className="img-cap">
//               <p><span className="bold-cap">STILL NOT ENOUGH TIME</span>  There has not been enough time to carry coffee cups from place to place before they get cold. 
//                 But if all the coffee cups were somehow filled from a single coffee pot, all at the same time, that might explain their even temperature</p>
//             </div>


//             <div className="img-cap">
//               <p><span className="bold-cap">NFLATION</span> solves this problem. The theory proposes that, less than a trillionth of a second after the Big Bang, the universe expanded faster than the speed of light. 
//                 Tiny ripples in the violently expanding energy field eventually grew into the large-scale structures of the universe.</p>
//             </div>


//             <div className="img-cap"><p>
//               <span className="bold-cap">FLUCTUATION</span> Astronomers have now detected evidence of these ancient fluctuations in swirls of polarized light in the cosmic background radiation, which is energy left over from the early universe. 
...
//             <div className="img-cap">
//               <p><span className="bold-cap">EXPANSION</span>  Returning to our coffee, imagine a single, central pot expanding faster than light and cooling to an even temperature as it expands. That is something like inflation. 
//                 And the structure of the universe mirrors the froth and foam of the original pot.</p>
//             </div>

//           </div>
//       </section>
//         <p><b>The Theory of Inflation</b></p>
//         <span className="desc"
...
//             <a href="https://www.youtube.com/watch?v=ZlfIVEy_YOA" className="nested-links"
...
//             </p>
//             <span className="desc">Video by StanfordUniversity</span>
//           </div>
//           <br />
...
//           <div className="contacts-subs">
//             <button type="submit">Read 615 comments</button>
...
//       </section >
//       <div className="Editorspicks-main">
//       <section className="Editors-picks">
//         <div className="container1-main-header">
//           <p>Suggested newsletters for you</p>
//           <a href="/">Don't show me this again</a>
//         </div>
//         <div className="picks-container1">
...
//               </div>
//               <div className="third-block-section">
...
//         </div>
//         <div className="Container2-main-header">
//           <p>More in Space and Astronomy</p>
//         </div>
//         <div className="picks-container2">
...
//       <section className="Editors-picks2">
//         <div className="article-sidenav">
          
//             <a className="article-links article-head" href="#"><p><b>Most Popular</b></p></a>
         
  
//             <a className="article-links" href="#"><p>Those Mystery Lights Above Seattle and Portland? They Weren’t Meteors.</p></a>
          
//             <a className="article-links" href="#"><p>Presidential Challenger Dies of Covid-19 Just Hours After Voting Ends</p></a>
          
//             <a className="article-links" href="#"><p>ulie Pomagalski, Former Olympic Snowboarder, Is Killed in an Avalanche</p></a>
         
//             <a className="article-links" href="#"><p>Those Mystery Lights Above Seattle and Portland? They Weren’t Meteors.</p></a>
          
          
//             <a className="article-links" href="#"><p> Editor Placed on Leave Following Racial Controversy</p></a>
           
//             <a className="article-links"  href="#"><p>Leno Apologizes for Years of Anti-Asian Jokes</p></a>
//             <a  className="article-links" href="#"><p>Jay Leno Apologizes for Years of Anti-Asian Jokes</p></a>
          
//             <a className="article-links" href="#"><p>Spring Clothes That Are Subtle in Hue but Decidedly Bold in Shape.</p></a>
    
//             <a className="article-links" href="#"><p>Divorce Rates Are Now Dropping. Here Are Some Reasons Why.</p></a>
    
//             <a className="article-links" href="#"><p>WHEELS Beige on an S.U.V. Will Cost You, but for Pickups It’s Golden</p></a>
 
//             <a className="article-links" href="#"><p>Woman Is Fatally Stabbed by Her Son During Video Call, Authorities Say</p></a>
...
//             <li><a >Science</a></li>
//             <li><a >Sports</a></li>
//             <li><a >obutiaries</a></li>
//             <li><a > Today's paper</a></li>
...
//           <ul>
//             <li><b>OPINION</b></li>
//             <li><a >Today's Opinion</a></li>
//             <li><a >Op-Ed columnists</a></li>
//             <li><a >Editorials</a></li>
//             <li><a >Op-Ed Contributors</a></li>
//             <li><a >Letters</a></li>
//             <li><a >Sunday Review</a></li>
//             <li><a>Video: Opinion</a></li>
//           </ul>
...
//           <ul>
//             <li><b>More</b></li>
//             <li><a >Reader Center</a></li>
//             <li><a >Wirecutter</a></li>
//             <li><a >Live Events</a></li>
//             <li><a >The Learning Network</a></li>
//             <li><a >Tools & Services</a></li>
//             <li><a >Multimedia</a></li>
//             <li><a >Photography</a></li>
//             <li><a >Video</a></li>
//             <li><a >Newsletter</a></li>
//             <li><a >TimesMachine</a></li>
//             <li><a >NYT Store</a></li>
//             <li><a >Times Journeys</a></li>
//             <li><a >Manage My Account</a></li>
//             <li><a >NYTLicensing</a></li>
//           </ul>
...
//             <li><a >Digital Subscriptions</a></li>
//             <li><a >Games</a></li>
//             <li><a >Cooking</a></li>
//             <li><a>Email Newsletters</a></li>
//             <li><a>Corporate Subscriptions</a></li>
//             <li><a >Education Rate</a></li>
//             <li><a >Mobile Applications</a></li>
//             <li><a >Replica Edition</a></li>
...
//         <ul>
//           <li><a>© 2021 The New York Times Company</a></li>
//           <li><a >NYTCo</a></li>
            ...
            <div className="Front_page_wrapper">
                ...
                <header className="container1">
                    <div className="left-nav">
                        ...
                        <a href="#" id="nav-tag"><b>SPACE & COSMOS</b></a>
                    </div>
                    <div id="logo">
                        <a href="#">
                            <img src="./images/The_New_York_Times_logo.png" id="logo-fig1" alt="logo" />
                    ...
                    <div className="Editorspicks-main">
                        ...
                        <section className="Editors-picks2">
                            <div className="article-sidenav">
                                ...
                                <a className="article-links" href="#"><p>Julie Pomagalski, Former Olympic Snowboarder, Is Killed in an Avalanche</p></a>
                    ...
                    <div className="Main-container">
                        ...
                        <div className="footer-main">
                            ...
                            <ul>
                                ...
                                {/* Assuming the cut off word 'Vi' was 'Video' and closing the tags */}
                            </ul>
                        </div>
                    </div>
                </footer>
